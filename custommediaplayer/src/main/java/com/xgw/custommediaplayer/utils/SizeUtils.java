...
public final class SizeUtils {
    ...
    public static int dp2px(final float dpValue) {
        if (MyMediaPlayerDelegate.getInstance().getApp() == null) {
            throw new UnsupportedOperationException("请先在application的oncreate里面执行MyMediaPlayerDelegate.getInstance().initApp(this)");
        }
        final float scale = MyMediaPlayerDelegate.getInstance().getApp().getResources().getDisplayMetrics().density;
    ...
    public static int sp2px(final float spValue) {
        ...
        final float fontScale = MyMediaPlayerDelegate.getInstance().getApp().getResources().getDisplayMetrics().scaledDensity;
